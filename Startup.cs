...
using state_management_chatbot.Services;
...
namespace state_management_chatbot
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IBot, Bots.StateBot>();

            //The state manager class, this is where 
            services.AddTransient<IResponseManagerService, ResponseManagerService>();
